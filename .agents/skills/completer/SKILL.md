...
4. No secret in repo; API keys → OS keychain by end of Phase 1.

5. Every feature lands with: test (unit + integration + e2e where UI), ADR under `docs/adr/`, i18n, docs update, CHANGELOG entry.
