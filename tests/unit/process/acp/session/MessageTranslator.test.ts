...
describe('MessageTranslator', () => {
  ...
  it('accumulates chunks for same messageId', () => {
    ...
    translator.translate({
      sessionId: 's1',
      update: { sessionUpdate: 'agent_message_chunk', messageId: 'm1', text: 'Hello ' },
    });
    const msgs = translator.translate({
      sessionId: 's1',
      update: { sessionUpdate: 'agent_message_chunk', messageId: 'm1', text: 'world' },
    });
  ...
  it('onTurnEnd clears completed entries (INV-S-12)', () => {
    ...
    translator.translate({
      sessionId: 's1',
      update: { sessionUpdate: 'agent_message_chunk', messageId: 'm1', text: 'test' },
    });
